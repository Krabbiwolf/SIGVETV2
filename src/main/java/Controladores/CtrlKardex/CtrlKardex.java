...
public class CtrlKardex {
    ...
    private SwingWorker<ArrayList<Kardex>, Void> currentWorker;
    ...
    private void cargarTabla() {
        ...
        currentWorker = new SwingWorker<ArrayList<Kardex>, Void>() {
            @Override
            protected ArrayList<Kardex> doInBackground() throws Exception {
                return dao.listarKardex(fechaInicio, fechaFin, tipoMovimiento, busqueda);
            }

            @Override
            protected void done() {
                try {
                    ArrayList<Kardex> lista = get();
                    ...
                    JOptionPane.showMessageDialog(vista, "Error al cargar Kardex: " + ex.getMessage());
                } finally {
                    currentWorker = null;
                }
            }
