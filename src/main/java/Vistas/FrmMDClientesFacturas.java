...
public class FrmMDClientesFacturas extends javax.swing.JInternalFrame implements MaestroDetalleVista {

    public FrmMDClientesFacturas() {
        initComponents();
    ...
    public String getTipo() {
        return MaestroDetalleVista.CLIENTES_FACTURAS;
    }
    ...
    private void initComponents() {
        ...
        txtBuscar.setToolTipText("Buscar por nombre, DUI o teléfono");
        ...
        btnActualizar.setBounds(700, 30, 130, 38);
        ...
        tblMaestro.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID", "Cliente", "DUI", "Telefono", "Direccion", "Estado"
            }
        ));
        ...
        lblDetalle.setText("Facturas o ventas del cliente seleccionado");
        ...
        tblDetalle.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID", "N° Comprobante", "Fecha y Hora", "Estado", "Cliente"
            }
        ));
